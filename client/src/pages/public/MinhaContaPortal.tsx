...
const STATUS_LABELS: Record<string, { label: string; icon: React.ElementType; color: string }> = {
  ...
  finalizado:           { label: "Feito",              icon: CheckCircle2, color: "bg-green-100 text-green-800 border-green-200" },
...
const NEXT_STEP_BY_STATUS: Record<string, { title: string; description: string; action: string; tone: string }> = {
  ...
  finalizado: { title: "Serviço feito", description: "Seu histórico, garantia e comprovantes permanecem disponíveis no portal.", action: "Ver histórico", tone: "bg-green-50 text-green-700 border-green-200" },
