...
const STATUS_CONFIG: Record<string, { label: string; icon: React.ElementType; color: string; dot: string }> = {
  ...
  finalizado:              { label: "Entregue reparado",               icon: CheckCircle2, color: "bg-green-100 text-green-800 border-green-200",    dot: "bg-green-500" },
  encerrado_sem_reparo:    { label: "Encerrado sem Reparo", icon: AlertCircle,  color: "bg-slate-100 text-slate-700 border-slate-200",   dot: "bg-slate-400" },
  encerrado_condenado:     { label: "Encerrado Condenado", icon: AlertCircle,  color: "bg-red-100 text-red-800 border-red-200",         dot: "bg-red-500" },
...
const NEXT_STEP_BY_STATUS: Record<string, { title: string; description: string; action: string }> = {
  ...
  finalizado: { title: "Aparelho entregue reparado", description: "Comprovantes, garantia e histórico ficam disponíveis para consulta.", action: "Ver documentos" },
  encerrado_sem_reparo: { title: "OS encerrada sem reparo", description: "O atendimento foi encerrado sem execução de reparo. Consulte o histórico para detalhes.", action: "Ver histórico" },
  encerrado_condenado: { title: "Aparelho condenado", description: "A assistência registrou inviabilidade de reparo. Consulte o histórico para detalhes.", action: "Ver histórico" },
