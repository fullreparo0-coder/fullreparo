...
const STATUS_CONFIG: Record<string, { label: string; icon: React.ElementType; color: string; dot: string }> = {
  ...
  finalizado:              { label: "Feito",               icon: CheckCircle2, color: "bg-green-100 text-green-800 border-green-200",    dot: "bg-green-500" },
...
const NEXT_STEP_BY_STATUS: Record<string, { title: string; description: string; action: string }> = {
  ...
  finalizado: { title: "Serviço feito", description: "Comprovantes, garantia e histórico ficam disponíveis para consulta.", action: "Ver documentos" },
