...
export const tenantBillingRecords = mysqlTable("tenant_billing_records", {
  ...
  notes: text("notes"),
  reviewStatus: mysqlEnum("reviewStatus", ["none", "pending_review", "approved", "rejected"]).notNull().default("none"),
  proofFileKey: varchar("proofFileKey", { length: 500 }),
  proofUrl: text("proofUrl"),
  proofMimeType: varchar("proofMimeType", { length: 100 }),
  proofOriginalName: varchar("proofOriginalName", { length: 255 }),
  proofSubmittedAt: timestamp("proofSubmittedAt"),
  proofSubmittedById: int("proofSubmittedById"),
...
export const serviceOrders = mysqlTable("service_orders", {
  ...
  orderType: varchar("orderType", { length: 32 }).notNull().default("normal"),
  originalServiceOrderId: int("originalServiceOrderId"),
  warrantyReturnStatus: varchar("warrantyReturnStatus", { length: 32 }),
  warrantyReturnReason: text("warrantyReturnReason"),
  warrantyReturnDiagnosis: text("warrantyReturnDiagnosis"),
  warrantyReturnResolvedAt: timestamp("warrantyReturnResolvedAt"),
  warrantyReturnHandledById: int("warrantyReturnHandledById"),
